import { cartValueFeeOperation, distanceFeeOperation, amountItemsFeeOperation, rushTimeFeeOperation, sumAllFees,  deliveryFee } from './operations'

describe('check the operation of card value', () => {
    it('cart value < 10 has surcharge', () => {
        let res = cartValueFeeOperation(8.90);
...
describe('check the operation of the sum of all fees', () => {
    it('fees with rush hour', () => {
        let res = sumAllFees(8.70, 900, 4, "2023-02-03T18:07");
        expect(res).toBeDefined()
        expect(res).toEqual(3.96)
    })
    it('fees without rush hour', () => {
        let res = sumAllFees(8.70, 900, 4, "2023-01-31T18:07");
        expect(res).toBeDefined()
...
describe('check the operation of the final delivery fee', () => {
    it('fees < 15', () => {
        let res =  deliveryFee(8.70, 900, 4, "2023-02-01T18:07");
        expect(res).toBeDefined()
        expect(res).toEqual(3.30)
    })
    it('fees > 15', () => {
